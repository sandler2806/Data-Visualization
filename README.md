...
There are 10 types of clothing and our model should predict which number to give a new image of clothing (in range of 0-9).
...
Our model will predict if the image is cat or a dog (cat = 1, dog = 2).
